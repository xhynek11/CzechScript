            ...
            <form action="includes/login_inc.php" method="post">
                ...
                if (isset($_GET['succes'])) {
                    if ($_GET['succes'] == "verified") {
                        echo '<p class="signupsucces">Your account is verified, you can log in now!</p>';
                    }
                    if ($_GET['succes'] == "pwdchange") {
                        echo '<p class="signupsucces">Your password is changed, you can sign up now with new password!</p>';
                    }
                }
                ?>
                ...
                <p class="signup">Did you <a href="forgotten.php">forget</a> the password!</p>
            </form>
        </div>
    </div>
</main>
